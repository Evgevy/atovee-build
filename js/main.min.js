...
/***/ "./js/modules/header/accordion-mobile.js":
/*!***********************************************!*\
  !*** ./js/modules/header/accordion-mobile.js ***!
  \***********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   accordionMobile: function() { return /* binding */ accordionMobile; }
/* harmony export */ });
function accordionMobile() {
  //   const arrowMenuBtns = document.querySelectorAll(".main-nav ul li a button");
  //   arrowMenuBtns.forEach((el) => {
...
/***/ "./js/modules/header/open-submenu-handler.js":
/*!***************************************************!*\
  !*** ./js/modules/header/open-submenu-handler.js ***!
  \***************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   openSubmenuHandler: function() { return /* binding */ openSubmenuHandler; }
/* harmony export */ });
function openSubmenuHandler() {
  var dropdownItems = document.querySelectorAll(".main-nav__item.main-nav__item--accent");
  dropdownItems.forEach(function (dropdownItem) {
    var categoryButton = dropdownItem;
    var categoryMenu = dropdownItem.querySelector(".main-nav__sub-list");
    if (!categoryButton || !categoryMenu) {
      return;
    }
    var handleClick = function handleClick(event) {
      // Проверяем, если ширина окна меньше или равна 1199 пикселей
      if (window.innerWidth <= 1199) {
        // Игнорируем клики по ссылкам с классом .main-nav__bottom-item
        if (event.target.closest('.main-nav__bottom-item')) {
          return;
        }

        // Игнорируем клики по элементам внутри подменю
    ...
    var handleMouseOver = function handleMouseOver(event) {
      ...
      // Игнорируем наведение на ссылки с классом .main-nav__bottom-item
      if (event.target.closest('.main-nav__bottom-item')) {
        return;
      }
    ...
    var handleMouseLeave = function handleMouseLeave(event) {
      ...
      // Игнорируем уход мыши с ссылок с классом .main-nav__bottom-item
      if (event.target.closest('.main-nav__bottom-item')) {
        return;
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initArrow: function() { return /* binding */ initArrow; }
/* harmony export */ });
var initArrow = function initArrow() {
  var accentItems = document.querySelectorAll('.main-nav__item--accent');

  // Функция для добавления стрелок
  var addArrows = function addArrows() {
    accentItems.forEach(function (item) {
      // Проверяем, есть ли уже стрелка (чтобы не добавлять несколько)
      if (!item.querySelector('svg')) {
        ...
        useElement.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', '#arrow');
  ...
  // Функция для проверки медиа-запроса и добавления/удаления стрелок
  var checkMediaQuery = function checkMediaQuery() {
    if (window.matchMedia('(max-width: 1199px)').matches) {
      addArrows(); // Добавляем стрелки, если разрешение подходит
    } else {
      removeArrows(); // Удаляем стрелки, если разрешение не подходит
    }
  };

  // Вызываем функцию checkMediaQuery при загрузке страницы
  checkMediaQuery();

  // Добавляем обработчик события resize, чтобы пересчитывать при изменении размера окна
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initRemove: function() { return /* binding */ initRemove; }
/* harmony export */ });
var initRemove = function initRemove() {
  var headerIcons = document.querySelector('.header__icons');
  var headerBottom = document.querySelector('.main-nav__list');
  var searchIcon = headerIcons.querySelector('.header__btn.search');
  var moveOtherIcons = function moveOtherIcons() {
    if (window.matchMedia('(max-width: 767px)').matches) {
      Array.from(headerIcons.children).forEach(function (icon) {
        if (icon !== searchIcon && !headerBottom.contains(icon)) {
          if (headerBottom.firstChild) {
            headerBottom.insertBefore(icon, headerBottom.firstChild);
          } else {
            headerBottom.appendChild(icon);
          }
        }
      });
    }
  ...
  moveOtherIcons();
  window.addEventListener('resize', moveOtherIcons);
};
...
var initSearch = function initSearch() {
  var searchButton = document.querySelector('.header__btn.search img');
  var searchInput = document.querySelector('.header__search-input');
  var checkScreenSize = function checkScreenSize() {
    var isMobile = window.matchMedia('(max-width: 767px)').matches;
    if (isMobile) {
      // Если экран мобильный, добавляем класс active навсегда
      searchInput.classList.add('active');
    } else {
      // На больших экранах убираем класс active, если он есть
  ...
  searchButton.addEventListener('click', function (event) {
    ...
    var isMobile = window.matchMedia('(max-width: 767px)').matches;
    if (!isMobile) {
      // Если экран не мобильный, переключаем класс active
...
/***/ "./js/modules/sliders/init-custom-slider.js":
/*!**************************************************!*\
  !*** ./js/modules/sliders/init-custom-slider.js ***!
  \**************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
var initCustomSlider = function initCustomSlider() {
  ...
  var swiper = new Swiper(slider, {
    pagination: {
      el: '.swiper-pagination.products__pagination',
      clickable: true
    },
    slidesPerView: 4,
    spaceBetween: 20,
  ...
  var slider1 = document.querySelector('[data-slider="customer2"]');
  if (!slider1) {
    return;
  }
  var swiper1 = new Swiper(slider1, {
    pagination: {
      el: '.swiper-pagination.articles__pagination',
      clickable: true
    },
    slidesPerView: 3,
    loop: true,
...
/* harmony import */ var _modules_header_accordion_mobile__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/header/accordion-mobile */ "./js/modules/header/accordion-mobile.js");
/* harmony import */ var _modules_header_open_submenu_handler__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/header/open-submenu-handler */ "./js/modules/header/open-submenu-handler.js");
/* harmony import */ var _modules_sliders_init_custom_slider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/sliders/init-custom-slider */ "./js/modules/sliders/init-custom-slider.js");
/* harmony import */ var _modules_init_arrow__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/init-arrow */ "./js/modules/init-arrow.js");
/* harmony import */ var _modules_init_search__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/init-search */ "./js/modules/init-search.js");
/* harmony import */ var _modules_init_remove__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/init-remove */ "./js/modules/init-remove.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_header_accordion_mobile__WEBPACK_IMPORTED_MODULE_8__.accordionMobile)();
  (0,_modules_header_open_submenu_handler__WEBPACK_IMPORTED_MODULE_9__.openSubmenuHandler)();
  (0,_modules_sliders_init_custom_slider__WEBPACK_IMPORTED_MODULE_10__.initCustomSlider)();
  (0,_modules_init_arrow__WEBPACK_IMPORTED_MODULE_11__.initArrow)();
  (0,_modules_init_search__WEBPACK_IMPORTED_MODULE_12__.initSearch)();
  (0,_modules_init_remove__WEBPACK_IMPORTED_MODULE_13__.initRemove)();
